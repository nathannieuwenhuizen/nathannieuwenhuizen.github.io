...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Website.data';
    var REMOTE_PACKAGE_BASE = 'Website.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 10477169;
      var PACKAGE_UUID = '593cc63d-e047-4711-b092-3f8ce873498d';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 7697992, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(7697992, 7698013, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(7698013, 7701180, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(7701180, 9574572, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(9574572, 10449544, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(10449544, 10477169, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Website.data');

    };
    Module['addRunDependency']('datafile_Website.data');
